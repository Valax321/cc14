...
static ConVar r_flashlightfov( "r_flashlightfov", "80.0", FCVAR_CHEAT );
static ConVar r_flashlightoffsetx( "r_flashlightoffsetx", "0", FCVAR_CHEAT );
static ConVar r_flashlightoffsety( "r_flashlightoffsety", "0", FCVAR_CHEAT );
static ConVar r_flashlightoffsetz( "r_flashlightoffsetz", "0", FCVAR_CHEAT );
